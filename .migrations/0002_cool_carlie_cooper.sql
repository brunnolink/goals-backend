ALTER TABLE "goal+completions" RENAME TO "goal_completions";--> statement-breakpoint
ALTER TABLE "goal_completions" DROP CONSTRAINT "goal+completions_goal_id_goals_id_fk";
